            ...
            <div className="row">
              <div className="col-lg-6 align-self-center mb-5 mb-lg-0">
                <div className="innovative-wrapper">
                  <h3 className="primary-text">Innovative With Experience <br className="d-none d-xl-block" /> UX Design 2019</h3>
            ...
            <div className="row">
              <div className="col-lg-4 col-sm-6 mb-4 mb-lg-0">
                <div className="card-speaker">
                  <img className="card-img rounded-0" src="img/home/speaker-1.png" alt="" />
              ...
              <div className="col-lg-4 col-sm-6 mb-4 mb-lg-0">
                <div className="card-speaker">
                  <img className="card-img rounded-0" src="img/home/speaker-2.png" alt="" />
                  <div className="speaker-footer">
                    <h4>Donald Markin</h4>
                    <p>UX/UI Designer Microsoft</p>
                  </div>
          ...
          <div className="container">
              ...
              <div className="row">
                <div className="col-sm-6 col-lg-4 mb-3 mb-lg-0">
                  <div className="sponsor-single">
                    <img className="img-fluid" src="img/home/sponsor1.png" alt="" />
                  </div>
                </div>
                <div className="col-sm-6 col-lg-4 mb-3 mb-lg-0">
                  <div className="sponsor-single">
                    <img className="img-fluid" src="img/home/sponsor2.png" alt="" />
                  </div>
                </div>
                <div className="col-sm-6 col-lg-4 mb-3 mb-lg-0">
                  <div className="sponsor-single">
                    <img className="img-fluid" src="img/home/sponsor3.png" alt="" />
                  </div>
                </div>
              </div>
            </div>
            <div className="sponsor-wrapper sponsor-wrapper--small">
              ...
              <div className="row">
                ...
                <div className="col-sm-6 col-lg-4 mb-3 mb-lg-0">
                  <div className="sponsor-single">
                    <img className="img-fluid" src="img/home/sponsor-sm-2.png" alt="" />
                  </div>
                </div>
                <div className="col-sm-6 col-lg-4 mb-3 mb-lg-0">
                  <div className="sponsor-single">
                    <img className="img-fluid" src="img/home/sponsor-sm-3.png" alt="" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="row no-gutters">
              <div className="col-sm-6 col-md-4">
                <a href="img/gallery/g1.png" className="img-gal">
                  <div className="single-imgs relative">				
                    <img className="card-img rounded-0" src="img/gallery/g1.png" alt="" />		
              ...
              <div className="col-sm-6 col-md-4">
                <a href="img/gallery/g2.png" className="img-gal">
                  <div className="single-imgs relative">				
                    <img className="card-img rounded-0" src="img/gallery/g2.png" alt="" />		
                    <div className="overlay">
                      <div className="overlay-content">
                        <div className="overlay-icon">
                          <i className="ti-plus" />
              ...
              <div className="col-sm-6 col-md-4">
                <a href="img/gallery/g3.png" className="img-gal">
                  <div className="single-imgs relative">				
                    <img className="card-img rounded-0" src="img/gallery/g3.png" alt="" />		
                    <div className="overlay">
                      <div className="overlay-content">
                        <div className="overlay-icon">
                          <i className="ti-plus" />
              ...
              <div className="col-sm-6 col-md-4">
                <a href="img/gallery/g4.png" className="img-gal">
                  <div className="single-imgs relative">				
                    <img className="card-img rounded-0" src="img/gallery/g4.png" alt="" />		
                    <div className="overlay">
                      <div className="overlay-content">
                        <div className="overlay-icon">
                          <i className="ti-plus" />
              ...
              <div className="col-sm-6 col-md-4">
                <a href="img/gallery/g5.png" className="img-gal">
                  <div className="single-imgs relative">				
                    <img className="card-img rounded-0" src="img/gallery/g5.png" alt="" />		
                    <div className="overlay">
                      <div className="overlay-content">
                        <div className="overlay-icon">
                          <i className="ti-plus" />
              ...
              <div className="col-sm-6 col-md-4">
                <a href="img/gallery/g6.png" className="img-gal">
                  <div className="single-imgs relative">				
                    <img className="card-img rounded-0" src="img/gallery/g6.png" alt="" />		
                    <div className="overlay">
                      <div className="overlay-content">
                        <div className="overlay-icon">
                          <i className="ti-plus" />
